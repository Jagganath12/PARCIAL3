...
#Calcula el ángulo de torsión (dihedral angle) entre cuatro átomos especificados por sus coordenadas tridimensionales.
...
#Recupera las coordenadas de un átomo específico en un residuo y cadena del DataFrame.
...
#Clasifica un residuo en categorías según su polaridad y propiedades químicas.
...
#Generar gráficos que muestran la distribución de los ángulos phi y psi.
...
#Muestra la frecuencia de cada tipo de residuo en el conjunto de datos y Muestra la distribución de residuos según su clasificación química..
def generate_histogram_and_barplot(angles_df, prot_pdb):
    ...
    plt.title("Frequency of residues in the Ramachandran plot")
...
def main():
    ...
    global aminoacids, polar, polar_pos, polar_neg, nonpolar_ali, nonpolar_aro
    ...
    hist_plot_name, classification_name = generate_histogram_and_barplot(angles_df, prot_pdb)
